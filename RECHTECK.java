...
public class RECHTECK extends RechteckE {
     ...
     *                    dieser Methode dieses Rechteck
     *                    sichtbar. Ist dieser Wert <code>false</code>, so ist nach
     *                    dem Aufruf dieser Methode dieses Rechteck unsichtbar.
     */
    ...
    /**
     * Verschiebt dieses Rechteck um eine Verschiebung - angegeben durch ein "Delta
     * X" und "Delta Y".
     * 
     * @param deltaX Der X Anteil dieser Verschiebung. Positive Werte verschieben
     *               nach rechts, negative nach links.
     * @param deltaY Der Y Anteil dieser Verschiebung. Positive Werte verschieben
    ...
    /**
     * Diese Methode prueft, wie weit der Mittelpunkt dieses Rechtecks vom
     * Mittelpunkt
