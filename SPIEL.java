...
/**
 * Die Klasse SPIEL ist ein Template, das so wie es ist an Schueler ausgegeben
 * werden kann.
 * (Einzige Voraussetzung ist, dass die engine-alpha-Bibliothek im Suchpfad
 * erreichbar ist.)
 * Es startet alles Notwendige fuer ein Spiel.
 * 
 * Beim Konstruktor ohne Parameter gibt es keine Punkte-Anzeigen und auch keine
 * Maus-Interaktion.
 * Die Methoden tick() und tasteReagieren() werden immer automatisch aufgerufen.
 * 
 * Beim Konstruktor mit Parametern koennen die linken und rechten
 * Punkte-Anzeigen sowie die
...
public class SPIEL {
     ...
     */
    public void tick() {
        // Einfache Bildschirmausgabe. Kann spaeter in Subklasse beliebig ueberschreiben
        // werden.
        zaehler++;
        zaehler = zaehler % 2;
        if (zaehler == 1) {
    ...
    public void klickReagieren(int x, int y) {
        // Einfache Bildschirmausgabe. Kann spaeter in Subklasse beliebig ueberschrieben
        // werden.
    ...
    /**
     * Sorgt dafuer, dass sowohl der rechte als auch der linke Punktestand sichtbar
     * ist.
     */
    ...
    /**
     * Wartet um die Angegebene Anzahl an Millisekunden bis zur Ausfuehrung des
     * naechsten Befehls.
     *
